...
import JpgToSvgConverter from '@/components/converter/jpg/JpgToSvgConverter';
import ConverterSkeleton from '@/components/converter/ConverterSkeleton';

export const metadata: Metadata = {
  title: 'JPG to SVG Converter - Scalable Graphics | Converto Tomato',
  description: 'Convert JPG to SVG format. Create scalable vector graphics from raster images. 100% free and secure.',
  keywords: ['jpg to svg', 'svg converter', 'vector graphics', 'scalable images', 'image to svg'],
};
      ...
      <div className="container max-w-4xl">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Convert JPG images to scalable SVG format
          </p>
        </header>
