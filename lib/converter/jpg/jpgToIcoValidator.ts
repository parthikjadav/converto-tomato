/**
 * JPG File validation utilities for ICO conversion
 */

export const ALLOWED_TYPES = ['image/jpeg', 'image/jpg'];
export const MAX_FILE_SIZE = 10 * 1024 * 1024; // 10MB
export const MAX_FILES = 5; // Maximum number of files for ICO conversion
...
/**
 * Validate if file is a valid JPG image
 */
export function validateFile(file: File): void {
  // Check file type
  if (!ALLOWED_TYPES.includes(file.type.toLowerCase())) {
    throw new FileValidationError(
      'Invalid file type. Only JPG/JPEG files are allowed.'
    );
  }
