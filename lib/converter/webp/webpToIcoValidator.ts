/**
 * WebP File validation utilities for ICO conversion
 */

export const ALLOWED_TYPES = ['image/webp'];
...
/**
 * Validate if file is a valid WebP image
 */
export function validateFile(file: File): void {
  // Check file type
  if (!ALLOWED_TYPES.includes(file.type.toLowerCase())) {
    throw new FileValidationError(
      'Invalid file type. Only WebP files are allowed.'
    );
  }
